	...
	return (
		<Fragment>
			<div className='flex flex-row items-stretch align-middle bg-white rounded-xl'>
				<div className='p-3 w-1/3 h-full flex flex-col'>
						{<div className='p-3 bg-blue-400 flex items-center justify-center h-full cursor-pointer' onClick={openNewChatHandler}>
							Start new chat
						</div>}
				...
				{showMenu &&
					<div id="modal-root" className="bg-gray-700 bg-opacity-50 fixed w-full h-full left-0 top-0 z-10 flex flex-col items-center justify-center" onClick={closeMenu}>
