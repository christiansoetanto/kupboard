...
const AddClothing = (props) => {
	...
	const submitHandler = (event) => {
		...
		sendRequest({ url: "clothing/xu7Di7YPp4hvrN250XWwqcy7YVLY", method: "POST", body: newClothingData }, (result) => {
			console.log(result);
	...
	return (
		<Card>
			<form onSubmit={submitHandler}>
				<div className='p-5 m-5 bg-gray-300'>
				...
				<label className='block'>
					...
					<input className='form-input mt-1 block w-full' placeholder='' ref={inputNameRef} />
				</label>
