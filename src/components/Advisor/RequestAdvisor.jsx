            ...
            customUI: ({ onClose }) => {
              return (
                <CallbackAlert
                  onClose={onClose}
                  status={"Success"}
                  customMessage={"Request submitted successfully"}
                />
              );
            },
            afterClose: () => {
      ...
      <div className='bg-white shadow-xl border p-3 rounded-lg'>
        <div className='flex flex-col m-2 items-center justify-center text-gray-700'>
          <div className='text-lg mt-2 mb-4'>
            Join us as a fashion advisor and help the community to gain insights
            about fashion!
          </div>
          <label className='block w-full mb-3'>
            <span className='text-gray-500 text-sm'>DESCRIPTION</span>
            <textarea
              className=' mt-1 block w-full py-2 focus:outline-none bg-transparent border-2 rounded border-gray-300 text-sm md:text-base'
